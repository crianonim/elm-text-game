...
var $author$project$Game$addCounter = F3(
...
var $author$project$Game$getMaybeGameValue = F2(
	...
	function (dialogActionExecution, gameState) {
		switch (dialogActionExecution.$) {
			...
			case 'Inc':
				...
				var gv = dialogActionExecution.b;
				return A2(
...
var $author$project$Game$badDialog = {
	id: 'bad',
	options: _List_Nil,
	text: $author$project$Game$S('BAD Dialog')
};
...
var $author$project$Game$introText = function (gameState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						'It is now ' + (A2(
							...
							A2(
								...
								A2($elm$core$Dict$get, 'turn', gameState.counters))) + ' turn. '))
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Game$introText(gameState)
						])),
					A2(
					$elm$html$Html$h2,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Game$getText, gameState, dialog.text))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
...
var $author$project$Main$view = function (model) {
	var dialog = A2(
		...
		model.dialogs);
	var _v0 = A2($elm$core$Debug$log, 'stack', model.gameState.dialogStack);
	var _v1 = A2(
		$elm$core$Debug$log,
		'test',
		A2(
			$author$project$Game$testCondition,
			$author$project$Game$NOT(
				A3(
					$author$project$Game$Predicate,
					$author$project$Game$Counter('money'),
					$author$project$Game$LT,
					$author$project$Game$Const(43))),
			model.gameState));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
